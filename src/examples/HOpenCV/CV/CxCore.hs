...
instance Storable CvSize where
    sizeOf    _ = ((8))
{-# LINE 29 "HOpenCV/CV/CxCore.hsc" #-}
    alignment _ = alignment (undefined :: CInt)
    peek ptr = do
        w <- ((\hsc_ptr -> peekByteOff hsc_ptr 0)) ptr
{-# LINE 32 "HOpenCV/CV/CxCore.hsc" #-}
...
instance Storable CvRect where
    sizeOf    _ = ((16))
{-# LINE 60 "HOpenCV/CV/CxCore.hsc" #-}
    alignment _ = alignment (undefined :: CInt)
    peek ptr = do
        x <- ((\hsc_ptr -> peekByteOff hsc_ptr 0)) ptr
{-# LINE 63 "HOpenCV/CV/CxCore.hsc" #-}
...
{-# LINE 119 "HOpenCV/CV/CxCore.hsc" #-}
