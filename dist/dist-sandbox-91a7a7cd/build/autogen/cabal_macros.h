...
/* package allocated-processor-0.0.2 */
#define VERSION_allocated_processor "0.0.2"
#define MIN_VERSION_allocated_processor(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  0 || \
...
#define CURRENT_PACKAGE_KEY "HasOp_5SQgIa68rnX5zErUhyWZTe"
